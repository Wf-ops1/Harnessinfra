...
### Promoção observada da F2.3

| Evidência | Resultado observado |
|---|---|
| PR da tarefa | [#9](https://github.com/Wf-ops1/Harnessinfra/pull/9), mesclado e fechado em 2026-08-07 |
| Commits da tarefa | gate `ea6cec8fc29e0d4cbfc73681caa0965d4a38f26e` e implementação `8664ea6061ab5a60623f487ad90899d3c53ff357`; ambos ancestrais confirmados de `origin/main` |
| Merge commit | `60597c3a12af8c15ef7c2e416c448f69d98941d0`, com pais `b8307ca334e843bd00101872ac59669986008e75` e `8664ea6061ab5a60623f487ad90899d3c53ff357`; merge commit real |
| CI do PR | [run 31192232855](https://github.com/Wf-ops1/Harnessinfra/actions/runs/31192232855), evento `pull_request`, 10 jobs de matriz + `CI required`, todos `completed/success` |
| CI pós-merge | [run 31192555316](https://github.com/Wf-ops1/Harnessinfra/actions/runs/31192555316), evento `push` em `main`, commit `60597c3`, 10 jobs de matriz + `CI required`, todos `completed/success` |
| Alinhamento local | `git fetch origin main`; atualização fast-forward; `main == origin/main == 60597c3`; worktree limpa antes da criação da branch F2.4 |
| Checkpoints locais | `checkpoint/f2.3-ready^{}` em `ea6cec8`; `checkpoint/f2.3-complete^{}` em `8664ea6`; tags não publicadas |
| Preservação | `task/f2.3-graph-executor` permanece local e remota; `checkpoint/f2.3-complete` está ausente do remoto; nenhuma branch remota foi excluída |

---

### Promoção observada da F2.4

| Evidência | Resultado observado |
|---|---|
| PR da tarefa | [#10](https://github.com/Wf-ops1/Harnessinfra/pull/10), mesclado e fechado em 2026-08-07 |
| Commits da tarefa | gate `c944ca6f3e61c227a7719ff0838fbe7a27df9465` e implementação `9d792ac347f497a7f9fcb72cf50cf1cd0802785b`; ambos ancestrais confirmados de `origin/main` |
| Merge commit | `05799906099c2ff77a497867d653ba8be049bde8`, com pais `60597c3a12af8c15ef7c2e416c448f69d98941d0` e `9d792ac347f497a7f9fcb72cf50cf1cd0802785b`; merge commit real |
| CI do PR | 11/11 checks concluídos e verdes, incluindo o agregado obrigatório `CI required` |
| CI pós-merge | [run 31202447617](https://github.com/Wf-ops1/Harnessinfra/actions/runs/31202447617), evento `push` em `main`, commit `0579990`, 4 jobs de qualidade + 4 de testes + 2 de pacote + `CI required`, todos `completed/success` |
| Alinhamento local | `git fetch origin main`; `git switch main`; atualização fast-forward; `main == origin/main == 0579990`; worktree limpa antes da criação da branch F2.5 |
| Checkpoints locais | `checkpoint/f2.4-ready^{}` em `c944ca6`; `checkpoint/f2.4-complete^{}` em `9d792ac`; tags ausentes do remoto |
| Preservação | `task/f2.4-event-fsm` permanece local e remota; nenhuma branch/tag remota foi excluída ou criada durante o merge |

---

### Promoção observada da F2.5

| Evidência | Resultado observado |
|---|---|
| PR da tarefa | [#11](https://github.com/Wf-ops1/Harnessinfra/pull/11), mesclado e fechado em 2026-08-07 |
| Commits da tarefa | gate `bafca140f781e4dbb320c6324a8aa7629987c04d` e implementação `e871fadefe11f090ccee276e9b16101e47f54751`; ambos ancestrais confirmados de `origin/main` |
| Merge commit | `2aa324b394d9ffcfa0b8d0f9ba011f02f5a96727`, com pais `0579990` e `e871fad`; merge commit real |
| CI do PR | 11/11 checks concluídos com `success`, incluindo o agregado obrigatório `CI required` |
| CI pós-merge | [run 31209619778](https://github.com/Wf-ops1/Harnessinfra/actions/runs/31209619778), evento `push` em `main`, commit `2aa324b`, 10 jobs de matriz + `CI required`, todos `completed/success` |
| Alinhamento local | `git fetch origin main`; `git switch main`; atualização fast-forward; `main == origin/main == 2aa324b`; branch documental criada somente depois do CI verde |
| Checkpoints locais | `checkpoint/f2.5-ready^{}` em `bafca14`; `checkpoint/f2.5-complete^{}` em `e871fad`; tags não publicadas |
| Preservação | `task/f2.5-execution-resume` permanece local e remota; nenhuma branch/tag remota foi excluída |
